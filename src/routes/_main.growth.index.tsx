  ...
  return (
    <GrowthBackdrop>
      ...
      <section className="px-5 pt-7 pb-12">
          ...
          {WORKSHOPS.map((w) => (
            <li key={w.id}>
              ...
              >
                ...
                <div className="flex items-center pr-1 text-stone">
        ...
        {/* Roadmap whisper */}
        <p className="mt-7 text-center font-body text-[11.5px] italic text-stone">
          Six-week arcs renew gently. Nothing expires; nothing is graded.
        </p>
      </section>
    </GrowthBackdrop>
  );
