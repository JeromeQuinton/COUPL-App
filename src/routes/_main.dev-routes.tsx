...
const SECTIONS: { title: string; rows: { label: string; to: string; params?: Record<string, string> }[] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Community room (live picker target)", to: "/host/new/community-room" },
      { label: "Community step 1 (orphan, Phase-4 delete)", to: "/host/new/community" },
      { label: "Community step 2 (orphan, Phase-4 delete)", to: "/host/new/community-detail" },
      { label: "Community step 3 (orphan, Phase-4 delete)", to: "/host/new/community-review" },
